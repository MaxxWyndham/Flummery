...
namespace Flummery
{
    public partial class frmReincarnationMaterialEditor : Form
    {
        MaterialItem parent;
        MT2 material;
        ...
        private void cboBaseMaterial_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (((ComboBox)sender).Text)
            {
                ...
                case "car_shader_no_normals_base":
                    ...
                    txtDiffuse2.Tag = "decals";
                    txtSpecular2.Tag = "decalsspec";
                    break;
        ...
        {
            var controls = x.Controls.Cast<Control>();
